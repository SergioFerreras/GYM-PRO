...
import org.example.gympro.Clases.Actividad;
...
public class ReserveActivityMorningController {
    ...
    private void confirmReserve(ActionEvent event) {
        ...
        if (diezadoce.isSelected()){
            try {
                dbc.reserveActivity(getUser().getUsername(),"Cardio Activity 1","Sala 2",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        }else if (doceados2.isSelected()){
            try {
                dbc.reserveActivity(getUser().getUsername(),"Yoga Activity 1","Sala 2",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        }else if (ochoanueve.isSelected()){
            try {
                dbc.reserveActivity(getUser().getUsername(),"Normal Activity 1","Sala 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        } else if (nueveaonce.isSelected()) {
            try {
                dbc.reserveActivity(getUser().getUsername(),"Normal Activity 2","Sala 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        }else if (onceadoce.isSelected()) {
            try {
                dbc.reserveActivity(getUser().getUsername(),"Normal Activity 3","Sala 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        }else if (doceados.isSelected()) {
            try {
                dbc.reserveActivity(getUser().getUsername(),"Normal Activity 4","Sala 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()));
            } catch (SQLException e) {
                showPopUpWindow("Ha ocurrido un error.");
            }
        }
    ...
    private void selectactivitye(ActionEvent event) {
        ...
        if (diezadoce.isSelected()){
            ...
            hourLabel.setText("Hour: 10:00-12:00");
            activityLabel.setText("Cardio Activity 1");

            hourLabel1.setText("Hour: 10:00-12:00");
            activityLabel1.setText("Cardio Activity 1");
        }else if (doceados2.isSelected()){
            NormalActivityButton.setDisable(true);
            especialActivityButton.setDisable(true);
            popUp2.setVisible(false);
            ...
            hourLabel.setText("Hour: 12:00-14:00");
            activityLabel.setText("Yoga Activity 1");

            hourLabel1.setText("Hour: 12:00-14:00");
            activityLabel1.setText("Yoga Activity 1");
        }else {
    ...
    private void openEspecial(ActionEvent event) {
        ...
        if (!dbc.checkAvailability(getUser().getUsername(),"Cardio Activity 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))){
            diezadoce.setDisable(true);
        }
        if (!dbc.checkAvailability(getUser().getUsername(),"Yoga Activity 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))){
    ...
    private void selectactivityn(ActionEvent event) {
        ...
        if (ochoanueve.isSelected()){
            ...
            hourLabel.setText("Hour: 08:00-09:30");
            activityLabel.setText("Normal Activity 1");

            hourLabel1.setText("Hour: 08:00-09:30");
            activityLabel1.setText("Normal Activity 1");
        } else if (nueveaonce.isSelected()) {
            NormalActivityButton.setDisable(true);
            especialActivityButton.setDisable(true);
            popUp1.setVisible(false);
            ...
            hourLabel.setText("Hour: 09:30-11:00");
            activityLabel.setText("Normal Activity 2");

            hourLabel1.setText("Hour: 09:30-11:00");
            activityLabel1.setText("Normal Activity 2");
        }else if (onceadoce.isSelected()) {
            NormalActivityButton.setDisable(true);
            especialActivityButton.setDisable(true);
            popUp1.setVisible(false);
            ...
            hourLabel.setText("Hour: 11:00-12:30");
            activityLabel.setText("Normal Activity 3");

            hourLabel1.setText("Hour: 11:00-12:30");
            activityLabel1.setText("Normal Activity 3");
        }else if (doceados.isSelected()) {
            NormalActivityButton.setDisable(true);
            especialActivityButton.setDisable(true);
            popUp1.setVisible(false);
            ...
            hourLabel.setText("Hour: 12:30-14:00");
            activityLabel.setText("Normal Activity 4");

            hourLabel1.setText("Hour: 12:30-14:00");
            activityLabel1.setText("Normal Activity 4");
        }else {
            showPopUpWindow("No se ha seleccionado ninguna actividad");
        }
    }
    ...
    private void openNormala(ActionEvent event) {
        ...
        LocalTime t3 = LocalTime.of(11, 00);
        LocalTime t4 = LocalTime.of(12, 30);

        NormalActivityButton.setDisable(true);
        especialActivityButton.setDisable(true);
        popUp1.setVisible(true);

        if (!dbc.checkAvailability(getUser().getUsername(),"Normal Activity 1",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))){
            ochoanueve.setDisable(true);
        }
        if (!dbc.checkAvailability(getUser().getUsername(),"Normal Activity 2",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))) {
            nueveaonce.setDisable(true);
        }
        if (!dbc.checkAvailability(getUser().getUsername(),"Normal Activity 3",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))) {
            onceadoce.setDisable(true);
        }
        if (!dbc.checkAvailability(getUser().getUsername(),"Normal Activity 4",rutina.devolverParteCuerpoDDBBController(getUser().getUsername()))) {
    ...
    public void setUser(User user){
        ...
        int dia=dc.getDayOfWeekNumber();

        if (dia==7){
            seleepCard.setVisible(true);
        }
    }
    ...
    private void selectedButtons(){
        ...
        if (reserva==null){
            ...
            if(reserva.equals("Cardio Activity 1")){
                diezadoce.setDisable(true);
                selected5.setVisible(true);
            } else if (reserva.equals("Yoga Activity 1")) {
                doceados2.setDisable(true);
                selected6.setVisible(true);
            }else if (reserva.equals("Normal Activity 1")) {
                ochoanueve.setDisable(true);
                selected1.setVisible(true);
            }else if (reserva.equals("Normal Activity 2")) {
                nueveaonce.setDisable(true);
                selected2.setVisible(true);
            }else if (reserva.equals("Normal Activity 3")) {
                onceadoce.setDisable(true);
                selected3.setVisible(true);
            }else if (reserva.equals("Normal Activity 4")) {
                doceados.setDisable(true);
